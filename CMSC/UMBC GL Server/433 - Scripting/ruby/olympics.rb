...
#
# Reads in olympic data of a specific format and spits out 
#  an html doc displaying the data in tabular form
...
# reads in and parses the data file in a manner 
#  easily sorted and condensed to be printed by athletes
def readDataFile()
  begin
...
# reads in data and shapes into a fashion
#  that lends itself to medal counting and sorting by country
def convertCountry()
